...
# Filter dataset for the selected nutrients
bqprm_k <- bqprm %>% 
  filter(nutrients == "k")
bqprm_no3_n <- bqprm %>% 
...
write.csv(bqprm_no3_n, file = here("data", "bqprm_no3_n.csv"), row.names = FALSE)
write.csv(bqprm_mg, file = here("data", "bqprm_mg.csv"), row.names = FALSE)
write.csv(bqprm_ca, file = here("data", "bqprm_ca.csv"), row.names = FALSE)
write.csv(bqprm_nh4_n, file = here("data", "bqprm_nh4_n.csv"), row.names = FALSE)
```
